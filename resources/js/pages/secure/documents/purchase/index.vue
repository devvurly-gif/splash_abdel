<template>
    <div class="w-full">
        <div class="flex justify-between items-center mb-6">
            <h1 class="text-3xl font-bold text-text-primary m-0">{{ $t('document.purchase.title') }}</h1>
            <div class="flex gap-3">
                <select v-model="documentType" @change="handleTypeChange" class="py-2.5 px-4 border-2 border-surface-border rounded-lg text-sm cursor-pointer bg-bg-primary text-text-primary focus:outline-none focus:border-border-focus focus:ring-2 focus:ring-accent-primary-light">
                    <option value="invoice">{{ $t('document.purchase.invoice') }}</option>
                    <option value="receipt">{{ $t('document.purchase.receipt') }}</option>
                    <option value="return">{{ $t('document.purchase.return') }}</option>
                </select>
            ...
            <table class="w-full border-collapse">
                <thead class="bg-bg-secondary">
                    <tr>
                        ...
                        <th class="p-4 text-left font-semibold text-text-secondary text-sm border-b-2 border-surface-border">{{ $t('document.supplier') }}</th>
